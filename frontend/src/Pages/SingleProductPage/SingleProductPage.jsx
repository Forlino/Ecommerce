...
const SingleProductPage = () => {
    ...
    const addCartHandler = (Stock) => {
        if (Stock > 0) {
            ...
            alert.success("Producto añadido al carrito")
        }
        else {
    ...
    useEffect(() => {
        ...
        if (success) {
            alert.success("Reseña hecha con exito.");
                        ...
                        <div className="single-product-container">
                            ...
                            <div className="rght-side">
                                ...
                                <div className="status">
                                    <span className='status-text'>Estado:
                                        <span
                                ...
                                <p className="discription">
                                    <span className='discription-text'>Descripcion: </span>
                                    {product.description}
                                </p>
                                <button
                                    onClick={submitReviewToggle}
                                    className='submit-review btn'>Enviar reseña</button>
