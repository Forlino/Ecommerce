...
const LoginSignUp = () => {
    ...
    const registerSubmit = async (e) => {
        ...
        if (avatar) {
            ...
            alert.error("Es necesario un avatar para registrarse");
            return;
        }
        ...
        <>
            {
                loading
                    ...
                    : <div className="login-register-container">
                        <form className="form-container" onSubmit={currState === "Loguearse" ? loginSubmit : registerSubmit}>
                            ...
                            {
                                currState === "Login"
                                    ? <p className="forget-password-text">Olvide mi contraseña</p>
                                    : ""
                            }
                            ...
                            <div className="terms-condition-text">
                                ...
                                {currState === "Login" ? (
                                    <p>Crear nueva cuenta <span onClick={() => setCurState("Register")}>Click aqui</span></p>
                                ) : (
                                    <p>Ya estas registrado? <span onClick={() => setCurState("Login")}>Click aqui</span></p>
                                )}
                            </div>
                        </form>
                    </div>
