...
const UserNavOption = ({ user }) => {
    ...
    const navOption = [
        { icon: <FaListAlt style={{ fontSize: '16px' }} />, name: "Pedidos", func: orders },
        {
        ...
        { icon: <IoPerson style={{ fontSize: '16px' }} />, name: "Perfil", func: account },
        { icon: <MdExitToApp style={{ fontSize: '16px' }} />, name: "Desconectar", func: logoutUser },
    ]

    if (user?.role === "admin") {
        navOption.unshift({
            icon: <MdDashboard style={{ fontSize: '16px' }} />, name: "Panel", func: dashboard
        })
    }
